...
Live Translator: Real-time conversion between English, Eyean scripts, and Phonetic profiles.

Theme Engine: Toggle between Dark, Light, and High-Contrast modes for better accessibility.
...
Linguistic Protection: The Eyean linguistic system, including its cipher logic and phonetic mappings, is the sole property of the author.

Narrative Assets: All character names, situational dialogues, and unit storylines are protected creative works.
...
Web Audio API: Procedural audio synthesis for real-time sound effects.
